const en = {
  "en": {
    ...
    "withdraw_currency": {
      ...
      "cancel": "Cancel",
      "resend": "Resend",
      "temporarily_can_not_withdraw": "Withdrawal of this token is currently suspended.",
      "canceled": "Canceled",
      ...
      "sms": "SMS ",
      "poundage": "Fee",
      "withdraw_confirm_success": "Withdraw confirmation completed.",
      "withdraw_confirm_error": "The link is either expired or invalid",
    },
    "deposit_currency": {
      ...
      "temporarily_unable_deposit": "Deposit currently not open.",
    ...
    "title": {
      ...
      "form_amountrecord": "Asset breakdown",
      "api": "Api",
      "api_new": "New Key",
      "api_edit": "Edit Key",
      "ticket": "Ticket",
    ...
    "api_server": {
      ...
      "ticket": {
        "success_200": 'Ticket created!',
        "success_201": 'Ticket closed.',
        "success_203": 'Reminder manager.',
        "error_1001": "Ticket has been closed.",
        "error_1002": "Failed to comment.",
        "error_1003": "Failed to close ticket.",
        "error_1004": "Failed to create.",
    ...
    "homepage": {
      ...
      'mining': {
        'head': 'Interest mining',
        'des': "You are not a professional investor, you can't continue trading mining? It doesn't matter, you can also get OET by interest mining.",
        'deadline': 'Deadline',
        "rate": "Annualized rate of return",
        'dayback': "Daily feedback",
        'limit': "Investment quota",
        'remain': "Remaining amount",
        'day': 'Days',
        'action': "Action",
        'participate': 'participate',
        'newer': 'New user',
        'head': 'Are you sure to participate in interest mining?',
        'Recommender': 'Recommender',
        'partNum': 'Number of participants',
        'annualized': 'Basic annualized income',
        'reward1': 'Invitation reward',
        'reward2': 'Novice reward',
        'income': 'Total annualized income',
        'err_1001': 'Can not find the fixed term product',
        'err_1002': 'Authentication failed',
        'err_1003': 'Current product is completed',
        'err_1004': 'Can not deposit in current time',
        'err_1005': 'The remain volume is not enough',
        'err_1006': 'Volume must within the limits',
        'err_1007': 'Your deposit upon max volume',
        'err_1008': 'Your account volume is not enough',
        'err_1009': 'Order failed',
      }
    },
    "form": {
      "previous": "Prev",
    ...
    "dashboard": {
      ...
      "asset_curve": "Profit Curve",
      "others": "Others",
      "historical_income": "Historical Profit",
      "benchmark": " Base"
    },
